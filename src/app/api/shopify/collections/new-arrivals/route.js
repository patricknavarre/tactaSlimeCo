...
export async function GET() {
  try {
    ...
    const COLLECTION_ID = process.env.SHOPIFY_COLLECTION_NEW_ARRIVALS;
    
    if (!COLLECTION_ID) {
      console.error('SHOPIFY_COLLECTION_NEW_ARRIVALS is not defined in environment variables');
    ...
    // await syncToMongoDB(products, 'new-arrivals');
