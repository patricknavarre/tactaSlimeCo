...
function BestSellersContent() {
  ...
  useEffect(() => {
    async function fetchBestSellers() {
      try {
        setLoading(true);
        console.log('Fetching best sellers from Shopify...');
        const response = await fetch('/api/shopify/collections/best-sellers');
        ...
        console.log('Best sellers data received:', data);
        ...
        setError(`Failed to load best sellers: ${error.message}`);
      } finally {
        setLoading(false);
      }
    }
  ...
  const handleQuickAdd = (product) => {
    ...
    console.log("Adding to cart from best sellers:", productToAdd);
  ...
  return (
    <div className="container-custom py-8">
      ...
      >
        <h1 className="text-4xl font-bold text-gray-900 mb-4">Best Selling Slimes</h1>
        <p className="text-lg text-gray-700 max-w-3xl mx-auto px-4">
          Our most popular slimes that our customers absolutely love. These top-rated slimes deliver exceptional texture and sensory experiences.
        </p>
      </motion.div>
      ...
      {loading ? (
        ...
        <div className="text-center py-16 bg-white rounded-lg shadow-sm">
          ...
          <p className="text-gray-500">
            Check back soon! We're updating our best sellers collection.
          </p>
          <Link href="/products">
            <motion.span 
